export default {
  ...
  run: async (client, m, args) => {
    ...
    if (limit === 0) {
      chat.warnLimit = 0
      chat.expulsar = false
      return m.reply(`💙 Has desactivado la función de eliminar usuarios al alcanzar el límite de advertencias.`, m, global.miku)
    }
    chat.warnLimit = limit
    chat.expulsar = true
    await m.reply(`💙 Límite de advertencias establecido en \`${limit}\` para este grupo.\n> ❖ Los usuarios serán eliminados automáticamente al alcanzar este límite.`, m, global.miku)
  },
};