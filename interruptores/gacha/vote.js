...
export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    try {
      ...
      if (!character) {
        return m.reply(`🌱 Personaje no encontrado. Asegúrate de que el nombre esté correcto.`)
      }
